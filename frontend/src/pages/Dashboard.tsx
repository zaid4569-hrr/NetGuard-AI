  ...
  if (loading || !assessment) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-slate-400 gap-4">
        <div className="w-10 h-10 rounded-xl border-2 border-cyan-500/40 border-t-transparent animate-spin" />
        <p className="text-xs font-mono">Loading audit telemetry...</p>
      </div>
    );
  }
